...
void httpfehler()
{
		...
		printf("   <body>\n");			
		printf("   <center>\n");
		printf("Sorry, Please Don't Submit Pictures Larger Than 100.000 Bytes.<p>\n");
		printf("Press The BACK Button Of Your Browser Or Close This Window.\n");
		printf("   </center>\n");
		printf("   </body>\n");
		printf("</html>\n");		
}
...
/*			rhenv=getenv("REMOTE_ADDR"); 	*/
			...
			printf("   <body>\n");			
			printf("   <center>\n");
			printf("   <object classid=\"java:ImagenCalculator\" codebase=\"../\" codetype=\"application/java-vm\" width=700 height=400>\n");
			printf("   </object>\n");
			printf("   </center>\n");
			printf("   </body>\n");
			printf("</html>\n");		
