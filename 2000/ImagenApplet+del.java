	...
	public void paint(Graphics g)
	{
		...
		{	circsize=360/visize;
			...
			{	
				...
				if (i<VPnum-1)	g.drawLine(205+(VPx[i]*360)/visize+circsize/2,20+(VPy[i]*360)/visize+circsize/2,205+(VPx[i+1]*360)/visize+circsize/2,20+(VPy[i+1]*360)/visize+circsize/2);
			}
		}
	}
